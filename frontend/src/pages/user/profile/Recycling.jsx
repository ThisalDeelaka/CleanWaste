        ...
        <main className="flex-1 p-4 lg:ml-56"> {/* Margin adjusted to align with sidebar */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="bg-gray-100 shadow-md rounded-lg p-6 border border-gray-300">
              ...
              <p className="text-gray-700 mb-4">This represents the percentage of waste you have successfully recycled.</p>
            </div>
            ...
            <div className="bg-yellow-100 shadow-md rounded-lg p-6 border border-yellow-400">
              ...
              <p className="text-4xl font-extrabold text-yellow-600 mb-4">Rs. {revenue}</p> {/* Animated Revenue Count */}
